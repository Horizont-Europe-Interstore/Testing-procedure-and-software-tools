...
// public class GetADerCapabilitySteps {
    
//     private App app; 
//     private static final Logger LOGGER = LoggerFactory.getLogger(GetADerCapabilitySteps.class);
...
//     public void i_have_a_get_a_der_capability_test_setup() throws Exception {
//         app = (App) ApplicationContextProvider.getApplicationContext().getBean("app");
       
//     }

//     @When("^I execute the get a der capability test with subject \"([^\"]*)\"$")
//     public void i_execute_the_get_a_der_capability_test_with_subject(String natsSubject) throws Exception {
//         LOGGER.info("Expected response");
//         response = app.getADerCapability(natsSubject);
//     }

    
//     @Then("^the test should complete successfully with a der capability response containing:$")
//     public  void the_test_should_complete_successfully_with_a_der_capability_response_containing(String expectedJson) throws Exception {
...
//             }
//             else if( key.equals("DerCapability"))
//             {  
//                 {
