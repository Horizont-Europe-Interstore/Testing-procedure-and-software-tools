...
// public class GetADerSettingsSteps {
//     private App app; 
//     private static final Logger LOGGER = LoggerFactory.getLogger(GetADerSettingsSteps.class);
...
//     public void i_have_a_get_a_der_settings_test_setup() throws Exception {
//         app = (App) ApplicationContextProvider.getApplicationContext().getBean("app");
       
//     }

//     @When("^I execute the get a der settings test with subject \"([^\"]*)\"$")
//     public void i_execute_the_get_a_der_settings_test_with_subject(String natsSubject) throws Exception {
//         LOGGER.info("Expected response");
//         response = app.getADerSettings(natsSubject);
//     }

    
//     @Then("^the test should complete successfully with a der settings response containing:$")
//     public  void the_test_should_complete_successfully_with_a_der_settings_response_containing(String expectedJson) throws Exception {
...
//             }
//             else if( key.equals("DerSettings"))
//             {  
//                 {
